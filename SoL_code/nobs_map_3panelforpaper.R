...
pdf("SoL_graphics/nobsmaps/3pchltndoc.pdf", width=4, height=8)
par(mfrow=c(3,1), xpd=NA)
  ...
  points(twentyplus$nhd_long, twentyplus$nhd_lat, pch=21, col="black", lwd=.5, bg=rgb(34,94,168, 200,max=255), cex=.8)
  
  text(-97, 49.5, "a) Chlorophyll a", adj=c(0,0), cex=1.5)
  ...
  points(undertwenty$nhd_long, undertwenty$nhd_lat, pch=21, col="grey70", lwd=.5, bg=rgb(211,211,211, 200,max=255), cex=.8)
  points(twentyplus$nhd_long, twentyplus$nhd_lat, pch=21, col="black", lwd=.5, bg=rgb(34,94,168, 200,max=255), cex=.8)
  text(-97, 49.5, "b) Total Nitrogen", adj=c(0,0), cex=1.5)
  ...
  points(undertwenty$nhd_long, undertwenty$nhd_lat, pch=21, col="grey70", lwd=.5, bg=rgb(211,211,211, 200,max=255), cex=.8)
  points(twentyplus$nhd_long, twentyplus$nhd_lat, pch=21, col="black", lwd=.5, bg=rgb(34,94,168, 200,max=255), cex=.8)
  text(-97, 49.5, "c) Dissolved Organic Carbon", adj=c(0,0), cex=1.5)
