###Code for Fig. 7 and Fig. S1
###Also generates data for Table S2- 
#Note that if you run this code, the Table S2-related output will differ from the published Table S1
#Because the output is based on random draws, and thus is slightly different each time the code is run.
